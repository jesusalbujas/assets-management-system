 ...
 */
public abstract class AssetDeliveryProcessAbstract extends SvrProcess {
	/** Process Value 	*/
	private static final String VALUE_FOR_PROCESS = "SMS_Asset_Delivery_Process";
	/** Process Name 	*/
	private static final String NAME_FOR_PROCESS = "Asset Delivery Process";
	/** Process Id 	*/
	...
	/**	Parameter Name for PST_Employees	*/
	...
	private int assetId;
	/**	Parameter Value for PST_Employees	*/
	...
	/**	 Getter Parameter Value for PST_Employees	*/
	protected int getEmployeesId() {
		return employeesId;
	}

	/**	 Setter Parameter Value for PST_Employees	*/
